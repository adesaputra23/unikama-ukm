        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <span>UKM Paling diminati oleh Mahasiswa Baru adalah : UKM <b><?php echo e($string_ukm_name); ?></b></span>
...
<?php $__env->startSection('costum-js'); ?>
    <script>
        $(function() {
            var list_data_ukm = $.get("<?php echo e(url('ukm/ajax-get-grafik')); ?>/");
...
<?php echo $__env->make('template.partials', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/unikama-ukm/resources/views/dashboard.blade.php ENDPATH**/ ?>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="login-card card-block auth-body mr-auto ml-auto">
                        <div class="row">
                            <div class="col-md-12">
                                <img src="<?php echo e(asset('assets/images-logo/logo-ukm-unikama.jpg')); ?>" alt=""
                                    style="width: 30%; float: left; margin-right: 2%;">
                                <p class="text-center" style="font-size: 15px; font-weight: bold;">
                                    Sistem Pendukung Keputusan Memilih UKM Terbaik, Bagi Mahasiswa Baru
                                </p>
                            </div>
                        </div>
                        <form action="<?php echo e(route('login')); ?>" method="post" class="md-float-material">
                            <?php echo csrf_field(); ?>
                            <div class="auth-box">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" name="user_name" id="user_name"
                                        placeholder="NIDN/NPM" value="<?php echo e(old('user_name')); ?>" required>
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        ...
                                        <p class="text-inverse text-left"><b>SPK-UKM UNIKAMA</b></p>
                                    </div>
                                </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/unikama-ukm/resources/views/login/login.blade.php ENDPATH**/ ?>
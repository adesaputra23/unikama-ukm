    ...
    <div class="card-block">
        ...
        <ul class="breadcrumb-title b-t-default p-t-10">
            <li class="breadcrumb-item">
                ...
                <li class="breadcrumb-item"><a href="<?php echo e(url()->current()); ?>">Pegawai</a></li>
        </ul>
    </div>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $list_user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="align-middle"><?php echo e($user->pegawai->nama_pegawai); ?></td>
                                            <td class="align-middle"><?php echo e($role_user[$user->id_role]); ?></td>
                                            <td class="text-center align-middle">
                                                <img style="width: 5rem;" 
                                                    src="<?php echo e((!empty($user->pegawai->foto)) ? asset('file_foto_profil').'/'.$user->pegawai->foto : asset('assets/images/avatar-0.png')); ?>" 
                                                class="rounded" alt="...">
                                            </td>
      ...
      <form action="<?php echo e(route('pengguna.pegawai.save')); ?>" method="post">
        ...
        <div class="modal-body">
            <div class="form-group row">
                <label class="col-sm-3 col-form-label">Pilih Role</label>
                <div class="col-sm-9">
                    <select class="form-control" name="role" id="role" required>
                        <option value="" selected disabled>Pilih Role</option>
                        <option value="2">Kepala BAK</option>
...
<?php echo $__env->make('template.partials', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/unikama-ukm/resources/views/pengguna/pegawai/index.blade.php ENDPATH**/ ?>
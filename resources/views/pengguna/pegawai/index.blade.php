    ...
    <div class="card-block">
        ...
        <ul class="breadcrumb-title b-t-default p-t-10">
            <li class="breadcrumb-item">
                ...
                <li class="breadcrumb-item"><a href="{{url()->current()}}">Pegawai</a></li>
        </ul>
    </div>
@endsection
                                ...
                                <tbody>
                                    @foreach ($list_user as $item => $user)
                                        <tr>
                                            ...
                                            <td class="align-middle">{{$user->pegawai->nama_pegawai}}</td>
                                            <td class="align-middle">{{$role_user[$user->id_role]}}</td>
                                            <td class="text-center align-middle">
                                                <img style="width: 5rem;" 
                                                    src="{{(!empty($user->pegawai->foto)) ? asset('file_foto_profil').'/'.$user->pegawai->foto : asset('assets/images/avatar-0.png')}}" 
                                                class="rounded" alt="...">
                                            </td>
                                            <td class="text-center align-middle" style="width: 18%">
                                                <div class="btn-group btn-sm">
                                                    ...
                                                    {{-- <button type="button" class="btn btn-grd-info btn-sm">Detail</button> --}}
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
